...
class FastInstFootHead(nn.Module):
    """Lightweight FastInst-style head for single-foot segmentation."""
    ...
    def forward(self, features: torch.Tensor) -> torch.Tensor:
        ...
        foot_logits = weighted_instance_logits.max(dim=1, keepdim=True).values
